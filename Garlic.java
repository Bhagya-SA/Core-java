class Garlic {
    ...
    public Garlic(int id, String type, String color, double price, String origin, String brand,int quantity, String quality, String packaging, String grade, double weight,String flavor, String size, String harvestSeason, String exportCountry,boolean organic, String supplier, String storageType, double rating, String status) {

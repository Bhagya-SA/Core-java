class Lotion {
    ...
    public Lotion(int id, String brand, String variant, double volume, double price,String color, String scent, boolean parabenFree, boolean sulfateFree,String skinType, String manufacturer, String country, String expiryDate,String batchNumber, String ingredients, double phLevel, String usage,double rating, boolean organic, String status) {
